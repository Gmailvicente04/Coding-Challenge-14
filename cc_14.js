...
// Converting NodeLists to Arrays for Bulk Updates
...
addSupportTicket("Vicente Oswald", "Unable to access account", "High");
addSupportTicket("Jayson Tatum", "Payment not processing", "Medium");
addSupportTicket("Alexis Sanchez", "Error message on login", "Low");
addSupportTicket("Payton Pritchard", "Password reset not working", "High");
